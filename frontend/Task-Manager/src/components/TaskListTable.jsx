            ...
            <table className="min-w-full">
                <thead>
                    <tr className="text-left">
                        <th className="py-3 px-4 text-gray-700 dark:text-gray-300 font-medium text-[13px]">Name</th>
                        <th className="py-3 px-4 text-gray-700 dark:text-gray-300 font-medium text-[13px]">Status</th>
                        <th className="py-3 px-4 text-gray-700 dark:text-gray-300 font-medium text-[13px]">Priority</th>
                        <th className="py-3 px-4 text-gray-700 dark:text-gray-300 font-medium text-[13px] hidden md:table-cell">Created On</th>
                    </tr>
                </thead>
                <tbody>
                    {tableData.map((task) => (
